...
public class TagRepository implements Closeable {
  ...
  /**
   * Returns a list of posts which contains one or more of the tags passed as argument.
   * 
   * @param tags a list of tags
   * @return a list of posts which contains at least one of the tags passed as argument
   */
  ...
  /**
   * Returns a list of posts which contains none of the tags passed as argument.
   * 
   * @param tags a list of tags
   * @return a list of posts which contains none of the tags passed as argument
   */
   ...
   * @return a {@link Post} object equivalent to the document passed as argument
   */
